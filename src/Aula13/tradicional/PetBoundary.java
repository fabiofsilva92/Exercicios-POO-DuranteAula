...
public class PetBoundary extends Application {
    ...
    private void criarTabela(){
        ...
        TableColumn<Pet, String> col4 = new TableColumn<>("Peso");
        ...
        table.setItems(control.getListaPet());
...
//        Bindings.bindBidirectional(txtNascimento.textProperty(), control.nascimento, new LocalDateStringConverter());
        Bindings.bindBidirectional(txtNascimento.valueProperty(), control.nascimento);
        ...
        panCampos.add(new Label("Raca"), 0, 2);
